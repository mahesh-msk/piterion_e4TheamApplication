...
public class UserProfileCSSHandler extends AbstractCSSPropertySWTHandler implements ICSSPropertyHandler {
	...
	protected void applyCSSProperty(Control control, String property, CSSValue value, String pseudo, CSSEngine engine)
		...
		if (control instanceof UserProfileWidget) {
            ...
            }  else  if (BUTTON_BG.equalsIgnoreCase(property) && (value.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE)) {
                Color newColor = (Color) engine.convert(value, Color.class, control.getDisplay());
                userProfileWidget.setBackground(newColor);
            }  else  if (BUTTON_COLOR.equalsIgnoreCase(property) && (value.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE)) {
                Color newColor = (Color) engine.convert(value, Color.class, control.getDisplay());
                userProfileWidget.setForeground(newColor);
            }   else  if (BUTTON_HEADER.equalsIgnoreCase(property) && (value.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE)) {
                Color newColor = (Color) engine.convert(value, Color.class, control.getDisplay());
                userProfileWidget.setHeaderColor(newColor);
            }  
        }
